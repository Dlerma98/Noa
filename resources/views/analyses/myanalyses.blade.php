...
@section('title', 'Mis Análisis de Videojuegos - Noa')

@section('content')
    <div class="container mx-auto py-10">
        @if($analyses->isEmpty())
            <h1 class="text-4xl font-bold mb-6 text-center">No has publicado ningun analisis.</h1>
        @else
            <div class="container mx-auto py-10">
                <h1 class="text-4xl font-bold mb-6 text-center">Listado de mis analisis</h1>
                @endif
